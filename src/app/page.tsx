      ...
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-slate-900 via-slate-900/95 to-slate-950 p-8 lg:p-12 border border-slate-800 shadow-2xl">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-sm text-slate-400 mb-6 leading-relaxed">
            Your centralized system is active. Access your detailed identity markers, bind newly acquired domestic companion passports, and track live clinical travel updates below.
          </p>
            ...
            <div className="space-y-3 relative z-10">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Update owner informations, passport/NIC records, physical locations, and custom emergency contact proxies.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-3 relative z-10">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Manage pets information, microchip, vaccinations, medical records, and issue serial identification tracking links.
                </p>
              </div>
            </div>

            <div className="pt-4 mt-4 border-t border-slate-800/80 flex items-center justify-between text-xs font-bold text-orange-400">
              <span>Process Pet Management</span>
              <ArrowRightIcon />
            </div>
          ...
          >
            ...
            <div className="space-y-3 relative z-10">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Manage vaccination records, update certified vaccination timelines, register batch parameters, and view official verification tags.
                </p>
              </div>
            </div>
      ...
      <div className="bg-slate-900/60 rounded-2xl border border-slate-800 p-6 shadow-xl">
        <div className="flex items-center justify-between pb-4 border-b border-slate-800 mb-4">
          <div>
            ...
            <p className="text-xs text-slate-500">Live summary of pets details</p>
          </div>
        ...
        {!activeOwner.pets || activeOwner.pets.length === 0 ? (
          <div className="py-8 text-center text-xs text-slate-500 italic">
            No active companions configured under this session.
          </div>
        ) : (
