...
function PassportBookletContent() {
  ...
  async function handleStickerUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      console.error("Vercel upload failed:", err);
  ...
  async function handleSaveMicrochip(e: React.FormEvent) {
    ...
    try {
      ...
      alert("Microchip verification successfully!");
              ...
              <div className="relative z-30 flex flex-wrap items-center justify-between gap-4 bg-slate-900/60 p-2 rounded-2xl border border-slate-800 backdrop-blur-sm">
                <div className="flex flex-wrap items-center gap-1.5 w-full sm:w-auto">
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 flex-1 sm:flex-none text-center ${activeTab === "cover"
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 flex-1 sm:flex-none text-center ${activeTab === "microchip"
                      ? "bg-slate-800 text-orange-400 shadow-inner border border-slate-700"
                      : "text-slate-400 hover:text-slate-200 hover:bg-slate-800/40"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 flex-1 sm:flex-none text-center ${activeTab === "vaccines"
                      ? "bg-slate-800 text-orange-400 shadow-inner border border-slate-700"
                      : "text-slate-400 hover:text-slate-200 hover:bg-slate-800/40"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 flex-1 sm:flex-none text-center ${activeTab === "medical"
                      ? "bg-slate-800 text-orange-400 shadow-inner border border-slate-700"
                      : "text-slate-400 hover:text-slate-200 hover:bg-slate-800/40"
                      }`}
                  >
                          ...
                          {petList.map((pet) => {
                            ...
                            return (
                              <button
                                ...
                                className={`w-full flex items-center gap-2 p-1.5 rounded-lg transition-all border border-transparent text-left ${isSelected
                              ...
                              >
                                {pet.photoUrl || pet.photoImage ? (
                                  ...
                                  <div className={`w-4 h-4 rounded flex items-center justify-center text-[9px] font-bold ${isSelected ? "bg-orange-500 text-white" : "bg-slate-800 text-slate-400"
                                    }`}>
                                    {pet.name.charAt(0)}
                                  </div>
                                )}
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-800">
                      ...
                      <div className="p-8 lg:p-12 flex flex-col justify-between items-center text-center bg-gradient-to-b from-slate-900 via-slate-950 to-slate-950 relative overflow-hidden">
                        ...
                        <div className="mt-8 w-full text-center">
                          <p className="text-sm font-extrabold tracking-[0.2em] uppercase bg-gradient-to-r from-orange-400 via-amber-300 to-orange-500 bg-clip-text text-transparent">
                            Healthy Pet. Happy Journey.
                          </p>
                          <div className="mt-2 mx-auto w-16 h-[2px] rounded-full bg-gradient-to-r from-transparent via-orange-500/60 to-transparent"></div>
                        </div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                                ...
                                <div className="md:col-span-2 space-y-4 text-[11px] font-mono">
                                  ...
                                  <div className="flex justify-between items-end border-b border-slate-900/60 pb-1.5">
                                    <span className="text-slate-500 font-medium">Microchip No </span>
                          ...
                          <div className="p-6 lg:p-8 flex flex-col justify-between min-h-[420px] relative">
                            ...
                            <div className="space-y-6">
                              <div className="text-center pb-3 border-b border-slate-900">
                                ...
                                <p className="text-[9px] text-slate-500 uppercase tracking-widest mt-0.5">Official Vet Medical Personnel</p>
                              </div>
                        ...
                        <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-6 lg:p-8 space-y-8 shadow-xl">
                          <div className="border-b border-slate-800/80 pb-4">
                            <h4 className="text-sm font-extrabold text-white uppercase tracking-wider flex items-center gap-2">
                              <span className="text-orange-500">Microchip and Veterinary Registry Control</span>
                            </h4>
                            <p className="text-[11px] text-slate-400 mt-1">
                              Configure microchip details and update accredited practice endorsement files directly.
                            </p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                            ...
                            <form onSubmit={handleSaveClinic} className="space-y-4 bg-slate-950/40 p-5 rounded-2xl border border-slate-800/60 flex flex-col justify-between min-h-[460px]">
                              <div className="space-y-4">
                                ...
                                <div className="pt-2">
                                  ...
                                  <div className="flex items-center gap-3 bg-slate-950 p-2.5 rounded-xl border border-slate-800">
                                    ...
                                    <div className="text-[9px] text-slate-500 truncate">
                                      {uploadingSeal ? (
                                        <span className="text-sky-400 animate-pulse">Updating...</span>
                                      ) : clinicFormData.sealUrl ? (
                              ...
                              <div className="pt-4 mt-4 border-t border-slate-900">
                                ...
                                >
                                  {clinicSaving ? "Updating..." : "Save Veterinary Details"}
                                </button>
                              </div>
                            </form>
                          ...
                          <form onSubmit={handleSaveVaccination} className="p-5 rounded-2xl bg-slate-950 border border-orange-500/30 space-y-4 animate-fade-in text-xs">
                            <div className="flex items-center justify-between pb-2 border-b border-slate-900">
                              <span className="font-bold text-orange-400">
                                {editingVacId ? "Update Vaccination Record" : "Add New Vaccination Record"}
                              </span>
                              <button
                                type="button"
                            ...
                            <div>
                              <label className="block text-[10px] text-slate-500 uppercase mb-1">Veterinary Clinic</label>
                              <select
